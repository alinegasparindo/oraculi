class User < ApplicationRecord
  ...
  has_many :mentor_reviews, foreign_key: 'mentor_id', class_name: 'Reviews', dependent: :destroy
  has_many :mentee_reviews, foreign_key: 'mentee_id', class_name: 'Reviews', dependent: :destroy
